...
public class HeroInfoActRecAdapter extends RecyclerView.Adapter<HeroInfoActRecAdapter.ViewHolder>{
    ...
    public HeroInfoActRecAdapter(Context context,List<HeroData> datas){
        this.context = context;
        this.datas = datas;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hero_info,parent,false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            hero_img = (ImageView) itemView.findViewById(R.id.hero_img);
            hero_name = (TextView) itemView.findViewById(R.id.hero_name);
            hero_rank_1 = (ImageView) itemView.findViewById(R.id.hero_rank_1);
            hero_rank_2 = (ImageView) itemView.findViewById(R.id.hero_rank_2);
            hero_rank_3 = (ImageView) itemView.findViewById(R.id.hero_rank_3);
            hero_rank_4 = (ImageView) itemView.findViewById(R.id.hero_rank_4);
            hero_rank_5 = (ImageView) itemView.findViewById(R.id.hero_rank_5);
        }
    }
     ...
     * 设置点击事件方法
     */
    public void setOnItemClickListener(HeroInfoActRecAdapter.OnItemClickListener onItemClickListener){
