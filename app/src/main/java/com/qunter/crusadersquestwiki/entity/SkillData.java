...
public class SkillData {
    ...
    public String getSkillDetailUrl() {
        return SkillDetailUrl;
    }

    public void setSkillDetailUrl(String skillDetailUrl) {
        SkillDetailUrl = skillDetailUrl;
    }
}
